...
exports.login= async(req,res)=>{
    ...
    exports.rating = async (req, res) => {
        ...
        try {
         ...
         return res.json({msg:"rate success",finalproduct});
        } catch (error) {
          // console.log(error);
...
//get wishlist  de chaque user
      ...
      exports.myWishList = async(req,res) =>{
        try {
         ...
         // traja3 el status
          res.status(200).json({msg:" list of book ",User})
        } catch (error) {
console.log(error);
          // traja3 el status
...
// console.log(alreadyExistCart);
    ...
    for (let i= 0; i< orders.length; i++) {
      cartTotal = cartTotal + orders[i].price 
    }
...
exports.myOrder = async(req,res) =>{
  try {
    ...
    res.status(200).json({msg:" list of Order ",User})
  } catch (error) {
console.log(error);
